...
open class AlbumMixRepository: AlbumStreamRepository {
    ...
    open override func fetchCollection(streamId: String, paginationParams paginatedParams: FeedlyKit.PaginationParams, useCache: Bool = false) -> SignalProducer<PaginatedEnclosureCollection<Album>, NSError> {
